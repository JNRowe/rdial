Feature: Filter database events
    ...
    Scenario: Fetch events for specific year
        Given I have the database date_filtering/
        When I apply the Events.read method
    ...
    Scenario: Fetch events for specific month
        Given I have the database date_filtering/
        When I apply the Events.read method
        When I check return value for calling for_date on result with year=2011 and month=1
        Then I see 1 events

    Scenario: Fetch events for specific day
        Given I have the database date_filtering/
        When I apply the Events.read method
        When I check return value for calling for_date on result with year=2011, month=3 and day=1
        Then I see 1 events

    Scenario: Fetch events for current week
        Given I have the database date_filtering/
        When I apply the Events.read method
        When I check return value for calling for_week on result with year=2011 and week=9
        Then I see 1 events
